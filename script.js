...
let musicIndex = Math.floor(Math.random() * details.length + 1);
let plays = false;
...
playpausebtn.addEventListener("click", function () {
  ...
  <use xlink:href="images/sprites.svg#${
...
const playnextSong = function () {
  ...
  playpausebtn.innerHTML = `<use xlink:href="images/sprites.svg#icon-pause2"></use>`;
  musicSong.play();
  currentlyPlaying();
